...
/**
 * @brief Static initializer for #atd_list_node_t
 * @see atd_list_node_t
 */
 ...
 */
AUTO_LOCAL void ev_list_push_front(atd_list_t* handler, atd_list_node_t* node);
 ...
 * @param[in,out] node      Pointer to a new node
 */
AUTO_LOCAL void ev_list_push_back(atd_list_t* handler, atd_list_node_t* node);
 ...
 * @param[in,out] node      Pointer to a new node
 */
AUTO_LOCAL void ev_list_insert_before(atd_list_t* handler, atd_list_node_t* pos, atd_list_node_t* node);
 ...
 * @param[in,out] node      Pointer to a new node
 */
AUTO_LOCAL void ev_list_insert_after(atd_list_t* handler, atd_list_node_t* pos, atd_list_node_t* node);
 ...
 */
AUTO_LOCAL void ev_list_erase(atd_list_t* handler, atd_list_node_t* node);
 ...
 */
AUTO_LOCAL atd_list_node_t* ev_list_pop_front(atd_list_t* handler);
 ...
 */
AUTO_LOCAL atd_list_node_t* ev_list_pop_back(atd_list_t* handler);
 ...
 * @return              The first node
 */
AUTO_LOCAL atd_list_node_t* ev_list_begin(const atd_list_t* handler);
 ...
 * @return              The last node
 */
AUTO_LOCAL atd_list_node_t* ev_list_end(const atd_list_t* handler);
...
*/
AUTO_LOCAL atd_list_node_t* ev_list_next(const atd_list_node_t* node);
 ...
 */
AUTO_LOCAL atd_list_node_t* ev_list_prev(const atd_list_node_t* node);
